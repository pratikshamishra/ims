...
public class  imServer   extends UnicastRemoteObject implements iServer{
	...
	static HashMap<String,ArrayList<String>> unreadMessages=new HashMap<String, ArrayList<String>>();
...
friendList.put(user, new ArrayList<String>(friends));
}
@Override
public void addUnreadMessages(String friendUser,String message11) throws RemoteException {

	if(unreadMessages.get(friendUser)==null)
	{
		unreadMessages.put(friendUser, new ArrayList<String>());
		
	}
	ArrayList<String> a=new ArrayList<String>(unreadMessages.get(friendUser));
	a.add(message11);
	
	unreadMessages.put(friendUser, a);
}
@Override
public ArrayList<String> getUnreadMessages(String user) throws RemoteException {
	// TODO Auto-generated method stub
	return unreadMessages.get(user);
}
public void setFriendList(String serverFriend)
{
	friendList.put(serverFriend,new ArrayList<String>());
}
