...
public interface iServer extends Remote {
	...
	void addUnreadMessages(String friend,String message) throws RemoteException;
	ArrayList<String> getUnreadMessages(String user) throws RemoteException;
	void setFriendList(String server) throws RemoteException;
